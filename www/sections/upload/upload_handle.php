...
$Validate->SetFields('type', '1', 'inarray', 'Please select a valid type.', array('inarray' => legacy_array_keys($Categories)));
switch ($Type) {
	case 'Music':
		if (!$_POST['groupid']) {
			...
			$Validate->SetFields('releasetype',
				'1','inarray','Please select a valid release type.', array('inarray'=>legacy_array_keys($ReleaseTypes)));
