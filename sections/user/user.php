...
<?
	...
	if (($OwnProfile || check_perms('users_mod')) && $Warned != '1970-01-01 00:00:00') {
?>
...
<?
if ($RatioWatchEnds != '1970-01-01 00:00:00'
...
<?	if (check_perms('users_warn')) { ?>
		<table class="layout" id="warn_user_box">
			...
			<tr>
				...
				<td>
					<input type="checkbox" name="Warned"<? if ($Warned != '1970-01-01 00:00:00') { ?> checked="checked"<? } ?> />
				</td>
			</tr>
<?		if ($Warned == '1970-01-01 00:00:00') { // user is not warned ?>
			<tr>
